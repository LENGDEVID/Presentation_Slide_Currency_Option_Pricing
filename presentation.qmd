...
- **Left plot**: All three methods (Analytical, FTCS, CN) overlap perfectly when stable → numerical methods work when conditions are right
...
- **BTCS/CN advantage**: No stability restriction → can use 5-10× larger time steps → much faster computation
